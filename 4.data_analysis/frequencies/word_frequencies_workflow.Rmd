...
How many tokens and sentences does the corpus have?
```{r}
print(paste("The overall corpus has", sum(token_counts_per_doc$nr_tokens)/1000000, "million tokens."))
print(paste("The overall corpus has", sum(token_counts_per_doc$nr_sentences)/1000000, "million sentences"))
...
ggplot(frequency_summary_all, aes(x = date, y = monthly_count/1000, linetype = category)) +
  geom_line() +
  ...
  xlab(element_blank()) +
  labs(title = "Total monthly occurences, January 2015-February 2023") +
  theme_classic() +
  ...
  limits = c(0, (max(frequency_summary_all$monthly_count)/1000) + 10)
  ) 

ggsave("bw_aesthetic.png", device = "png",
