...
token_counts_per_doc <- mclapply(list_of_udpipe_chunks, get_token_counts, mc.cores = detectCores() - 1) %>% 
  bind_rows()

saveRDS(token_counts_per_doc, "data/token_counts_per_doc.rds")

test <- setdiff(doc_id_by_date$doc_id, token_counts_per_doc$doc_id)
