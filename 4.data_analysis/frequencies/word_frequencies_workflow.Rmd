...
alt_frequency_summary %>% 
  ...
  geom_vline(xintercept = as.numeric(key_dates[1:length(key_dates)]), linetype = 2, size = 0.1) +
  ...
  geom_text(aes(x = key_dates[5], y = 0, label = names(key_dates)[5]), vjust = -17, size = 1.8, check_overlap = TRUE) +
  geom_text(aes(x = key_dates[6], y = 0, label = names(key_dates)[6]), vjust = -22, size = 1.8, check_overlap = TRUE) +
  geom_text(aes(x = key_dates[7], y = 0, label = names(key_dates)[7]), vjust = -25, size = 1.8, check_overlap = TRUE) +
