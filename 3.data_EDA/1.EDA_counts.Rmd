...
key_dates <- list(dates = c(as.Date("2015-05-11"),
                        as.Date("2015-09-02"),
                        as.Date("2016-09-21"),
                        as.Date("2016-11-03"),
                        as.Date("2018-01-27"),
...
combined_counts %>% 
  ...
  geom_vline(xintercept = as.numeric(key_dates$dates[1:length(key_dates$dates)]), color = "#563a3a", linetype = 2, linewidth = 0.2) +
  geom_text(aes(x = key_dates$dates[1], y = 0, label = key_dates$events[1]), color = "#22209F", vjust = key_dates$color_graph_adjust[1], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[2], y = 0, label = key_dates$events[2]), color = "#22209F", vjust = key_dates$color_graph_adjust[2], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[3], y = 0, label = key_dates$events[3]), color = "#22209F", vjust = key_dates$color_graph_adjust[3], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[4], y = 0, label = key_dates$events[4]), color = "#22209F", vjust = key_dates$color_graph_adjust[4], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[5], y = 0, label = key_dates$events[5]), color = "#22209F", vjust = key_dates$color_graph_adjust[5], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[6], y = 0, label = key_dates$events[6]), color = "#22209F", vjust = key_dates$color_graph_adjust[6], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[7], y = 0, label = key_dates$events[7]), color = "#22209F", vjust = key_dates$color_graph_adjust[7], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[8], y = 0, label = key_dates$events[8]), color = "#22209F", vjust = key_dates$color_graph_adjust[8], size = 1.5, fontface = "bold", check_overlap = TRUE) +
  geom_text(aes(x = key_dates$dates[9], y = 0, label = key_dates$events[9]), color = "#22209F", vjust = key_dates$color_graph_adjust[9], size = 1.5, fontface = "bold", check_overlap = TRUE) +
...
combined_counts %>% 
  ggplot(aes(x = month, y = migration_prop)) +
    ...
    geom_vline(xintercept = as.numeric(key_dates$dates[1:length(key_dates$dates)]), linetype = 2, linewidth = 0.15) +
    geom_text(aes(x = key_dates$dates[1], y = 0, label = key_dates$events[1]), vjust = key_dates$bw_graph_adjust[1], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[2], y = 0, label = key_dates$events[2]), vjust = key_dates$bw_graph_adjust[2], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[3], y = 0, label = key_dates$events[3]), vjust = key_dates$bw_graph_adjust[3], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[4], y = 0, label = key_dates$events[4]), vjust = key_dates$bw_graph_adjust[4], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[5], y = 0, label = key_dates$events[5]), vjust = key_dates$bw_graph_adjust[5], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[6], y = 0, label = key_dates$events[6]), vjust = key_dates$bw_graph_adjust[6], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[7], y = 0, label = key_dates$events[7]), vjust = key_dates$bw_graph_adjust[7], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[8], y = 0, label = key_dates$events[8]), vjust = key_dates$bw_graph_adjust[8], size = 1.7, check_overlap = TRUE) +
    geom_text(aes(x = key_dates$dates[9], y = 0, label = key_dates$events[9]), vjust = key_dates$bw_graph_adjust[9], size = 1.7, check_overlap = TRUE) +
    ylab(element_blank()) +
    xlab(element_blank()) +
