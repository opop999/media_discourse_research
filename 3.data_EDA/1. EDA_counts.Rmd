...
combined_counts_per_media_and_month <- inner_join(all_articles_per_media_and_month, migration_articles_per_media_and_month, by = c("month" = "month", "searched_name"="sourceName")) %>% 
