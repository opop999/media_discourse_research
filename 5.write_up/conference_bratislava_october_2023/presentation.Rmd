...
- Exploring Czech media discourse of **refugees, asylum seekers, immigrants, and migrants (RASIM)** in **European migration crisis** context, 2015--2023. <br><br>
...
**Graph 1: Migration content proportion across media types. Graphs in color. Use Plotly if straightforward.**
...
- Shift in collocations of migration terms between periods, with a distinct focus on **alternative and mainstream media**.<br><br>
...
- The 2022 crisis was portrayed as a **close** reality, while the 2015 crisis was more **elusive**.<br><br>
...
- Calls for further Czech/international migration discourse research and interdisciplinary approach:
  - Unaddressed verbal aspects (e.g. metaphors).
  - Social media data.
